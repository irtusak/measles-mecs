...
Prepared 19 September 2026 · Surveillance data as of 14 September 2026
...
vaccination coverage for two-year-olds was **91.6%** in the most recent survey cycle. The level needed to
stop measles spreading is roughly **95%**. Averages also hide the real risk: measles finds communities where
coverage is low, and it spreads there even when the province as a whole looks well protected.
...
| 2026 to date | 1,038 (plus 81 probable) |

The multi-jurisdictional outbreak that began in October 2024 has accounted for **6,417 cases across ten
jurisdictions**. Because transmission of that strain continued for more than twelve months, Canada no
longer met the definition of elimination, and the status was lost in November 2025.

By September 2026 the outbreak has been declared over in most provinces. Five cases remain active, in
Manitoba and Ontario, across three health units.

## Who is getting sick

Of the 1,119 confirmed and probable cases reported in 2026:

- **86% were unvaccinated.** Only 5% had received two or more doses.
- **96% were infected inside Canada**, linked to known chains of transmission, rather than being imported.
- **41% were school-aged children** (5 to 17 years), and a further 20% were under five.
- **78 people were hospitalised.** Four babies were born with congenital measles. No deaths were reported.
...
you need about **96% coverage**; across the whole range, between roughly 94.5% and 97.4%. That is where the
familiar 95% target comes from. It is not a round number chosen for convenience — it is what the arithmetic
of this particular virus demands.

Canada is not there. National coverage for two-year-olds was 91.6% in the most recent cycle of the childhood
National Immunization Coverage Survey, and it has moved very little in a decade.
...
41% of 2026 cases were school-aged. Existing points of contact with the health system are the cheapest place
to find and fix missed doses.
...
- **Coverage data is not current.** The latest machine-readable national coverage survey is from **2021**.
  Coverage today may be higher or lower.
...
- **Comparing provincial case counts with provincial coverage is suggestive, not causal.** Manitoba reported
  680 cases this year and Ontario 32; their coverage figures differ, but so do many other things.
...
- Public Health Agency of Canada, *Measles and Rubella Weekly Monitoring Report*. Data as of 14 September
  2026. Open Government Licence – Canada.
